...
import { ArrowRight, CheckCircle, Clock, Eye, User, Zap, Shield, Users, Star, Menu, X } from 'lucide-react';
...
export default function TaskBoardLanding() {
  ...
  const stages = [
    { name: 'Assigned', icon: User, color: 'bg-blue-500', description: 'Tasks ready to start' },
    { name: 'In Progress', icon: Clock, color: 'bg-yellow-500', description: 'Work in motion' },
    { name: 'In Review', icon: Eye, color: 'bg-purple-500', description: 'Quality checks' },
    { name: 'Completed', icon: CheckCircle, color: 'bg-green-500', description: 'Done and delivered' }
  ];

  const features = [
    { icon: Zap, title: 'Lightning Fast', description: 'Lightweight design that loads instantly and keeps you productive' },
    { icon: Shield, title: 'Simple & Clean', description: 'No clutter, no confusion. Just your tasks organized beautifully' },
    { icon: Users, title: 'Team Focused', description: 'Perfect for teams that need clarity without complexity' }
  ];

  const testimonials = [
    { name: 'Sarah Chen', role: 'Product Manager', company: 'TechFlow', content: 'TaskBoard transformed how our team tracks progress. Simple yet powerful.' },
    { name: 'Mike Rodriguez', role: 'Dev Lead', company: 'StartupXYZ', content: 'Finally, a task manager that doesn\'t get in the way of actual work.' },
    { name: 'Emily Park', role: 'Designer', company: 'Creative Co', content: 'Clean interface, clear workflow. Everything we needed, nothing we didn\'t.' }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white overflow-hidden">
      ...
      <nav className="relative z-50 px-6 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <button className="bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 px-6 py-2 rounded-full font-semibold transition-all duration-300 transform hover:scale-105">
              Get Started
            </button>
          </div>
        ...
        {isMenuOpen && (
          <div className="md:hidden absolute top-full left-0 right-0 bg-slate-800 bg-opacity-95 backdrop-blur-sm border-t border-slate-700">
            <div className="px-6 py-4 space-y-4">
              ...
              <button className="w-full bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 px-6 py-2 rounded-full font-semibold transition-all duration-300">
                Get Started
              </button>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-4xl mx-auto">
            <div className="inline-flex items-center px-4 py-2 bg-slate-800 bg-opacity-50 rounded-full border border-slate-700 mb-8">
              ...
              <span className="text-sm text-gray-300">Simple. Effective. Powerful.</span>
            </div>
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-12 leading-relaxed max-w-3xl mx-auto">
              TaskBoard is a lightweight task management web app that helps you organize and track work through clear stages. 
              Designed for <span className="text-purple-400 font-semibold">simplicity</span> and <span className="text-blue-400 font-semibold">efficiency</span>.
            </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              Built for <span className="bg-gradient-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent">Modern Teams</span>
            </h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Everything you need to keep your workflow aligned and your projects moving forward
            </p>
          </div>
      ...
      <section id="how-it-works" className="px-6 py-20">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              Four Stages. <span className="bg-gradient-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent">Infinite Progress.</span>
            </h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              TaskBoard uses a proven four-stage workflow that keeps your team organized and productive
            </p>
          </div>
              ...
              return (
                <div key={index} className="text-center group">
                  <div className="relative mb-6">
                    <div className={`w-20 h-20 ${stage.color} rounded-3xl flex items-center justify-center mx-auto group-hover:scale-110 transition-transform duration-300 shadow-lg`}>
      ...
      {/* Testimonials */}
      <section id="testimonials" className="px-6 py-20 bg-slate-800 bg-opacity-30">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              Loved by <span className="bg-gradient-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent">Teams Worldwide</span>
            </h2>
          </div>
      ...
      <section className="px-6 py-20">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl md:text-6xl font-bold mb-6">
            Ready to <span className="bg-gradient-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent">Get Organized?</span>
          </h2>
          <p className="text-xl text-gray-300 mb-12 max-w-2xl mx-auto">
            Join thousands of teams who've streamlined their workflow with TaskBoard's simple, powerful approach to task management.
          </p>
          ...
          <p className="text-sm text-gray-400 mt-6">No credit card required • Free forever for small teams</p>
        </div>
      </section>
